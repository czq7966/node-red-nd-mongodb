...
module.exports = function(RED) {
    ...
    RED.nodes.registerType("nd-mongodb",MongoNode,{
        credentials: {
            user: {type:"text"},
    ...
    RED.nodes.registerType("nd-mg-out",MongoOutNode);
    ...
    RED.nodes.registerType("nd-mg-in",MongoInNode);
}
